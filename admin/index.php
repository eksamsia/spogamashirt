...
<body>
  ...
  <div class="wrapper bg-white">
    ...
    <div class="h4 text-muted text-center pt-2">Admin Gamashirt</div>
    <form class="pt-3" action="proses/login.php" method="POST">
      <div class="form-group py-2">
        <div class="input-field"> <span class="far fa-user p-2"></span>
          <input type="text" placeholder="Username Admin" required class="" name="username">
        </div>
      </div>
      <div class="form-group py-1 pb-2">
        <div class="input-field"> <span class="fas fa-lock p-2"></span>
          <input type="password" placeholder=" Password" required class="" name="password">
