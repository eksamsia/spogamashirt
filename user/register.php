        ...
        <div class="col-md-12 col-lg-10">
          <div class="wrap d-md-flex">
            ...
            <div class="login-wrap p-4 p-md-5">
              ...
              <form action="proses/registrasi.php" method="POST" class="signin-form">
                ...
                <div class="form-group mb-3">
                  <label class="label" for="password">No Handphone</label>
                  <input type="number" class="form-control" placeholder="no Handphone" name="no_hp" required>
                </div>
                <div class="form-group mb-3">
                  <label class="label" for="password">Usernmae</label>
