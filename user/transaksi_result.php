...
$lenght=$mysqli->query("SELECT max(id_transaksi) AS id FROM transaksi WHERE id_user = $_SESSION[user]");
$id = $lenght->fetch_assoc();

$list=$mysqli->query("SELECT * FROM transaksi WHERE id_transaksi = $id[id]");
$transaksi = $list->fetch_assoc();

$data=$mysqli->query("SELECT * FROM pengiriman WHERE id_transaksi = $id[id]");
        ...
        <table class="table">
          ...
          <tbody>
            <?php 
                   ...
                   $x=$mysqli->query("SELECT *, detail_transaksi.qty AS jumlah_beli FROM detail_transaksi JOIN produk ON detail_transaksi.`id_produk` = produk.`id_produk` WHERE id_transaksi = $id[id]");
