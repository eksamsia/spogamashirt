  ...
  <div class="container">
    ...
    <div class="billing_details">
      <div class="row">
        <div class="col-lg-8">
          <h3>Tambah Alamat</h3>
          <form class="row contact_form" action="proses/tambah_alamat.php" method="POST" novalidate="novalidate">
            <div class="col-md-6 form-group p_star">
              <input type="text" class="form-control" id="first" name="nama_penerima" placeholder="Nama Penerima">
            ...
            <div class="col-md-6 form-group p_star">
              <input type="number" class="form-control" id="last" name="no_hp" placeholder="No Hp">
              <!-- <span class="placeholder" data-placeholder="Nomor Handphone"></span> -->
            </div>


            <div class="col-md-12 form-group p_star">
              <select class="all_province form-control" name="province_destination" id="province_destination" onchange="get_city_destination(this);" required>
            ...
            <div class="col-md-12 form-group">
              <textarea class="form-control" name="alamat_lengkap" id="message" rows="1" placeholder="Alamat Lengkap"></textarea>
            </div>
        ...
        <div class="col-lg-4">
          ...
          <img src="https://img.freepik.com/free-vector/address-concept-illustration_114360-4747.jpg" style="width: 500px; height: 500px;" />
